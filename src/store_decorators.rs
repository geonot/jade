...
pub const STORE_DECORATORS: &[StoreDecoratorSpec] = &[
    ...
    StoreDecoratorSpec {
        name: "durable",
        arg: ArgKind::None,
        excludes: &["relaxed", "volatile", "mem"],
        summary: "WAL syncs with fsync after every record.",
    },
    StoreDecoratorSpec {
        name: "relaxed",
        arg: ArgKind::None,
        excludes: &["durable", "volatile", "mem"],
        summary: "WAL syncs are batched at transaction commits.",
    },
    StoreDecoratorSpec {
        name: "volatile",
        arg: ArgKind::None,
        excludes: &["durable", "relaxed", "mem"],
        summary: "WAL is never synced; crash durability is not promised.",
    },
    StoreDecoratorSpec {
        name: "graph",
        arg: ArgKind::None,
...
fn store_name(d: &StoreDecorator) -> &'static str {
    match d {
        ...
        StoreDecorator::Durable => "durable",
        StoreDecorator::Relaxed => "relaxed",
        StoreDecorator::Volatile => "volatile",
...
mod tests {
    ...
    fn every_store_variant_is_in_table() {
        let variants = [
            ...
            StoreDecorator::Durable,
            StoreDecorator::Relaxed,
            StoreDecorator::Volatile,
