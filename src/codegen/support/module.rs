...
impl<'ctx> Compiler<'ctx> {
    pub fn new(ctx: &'ctx Context, name: &str) -> Self {
        Self {
            ...
            by_ref_values: std::collections::HashSet::new(),
            local_struct_values: std::collections::HashSet::new(),
            phi_shape_error: None,
            ...
            current_drop_meta: mir::DropMeta::default(),
